...
# Tamaño del lote
tamano_lote = 10000  # Ajusta según sea necesario
numero_lote = 1

# Procesar los archivos HTML en lotes
for i in range(0, len(archivos_txt), tamano_lote):
    datos = []
    lote = archivos_txt[i:i + tamano_lote]
